...
| Ubuntu 23.04                 | `cmake` `gcc` `git` `qt6-base-private-dev` `qt6-declarative-dev` `libgl-dev`                  | `libqt6network6` `libqt6sql6` `libqt6widgets6` `qml6-module-qtqml-workerscript` `qml6-module-qtquick-controls` `qml6-module-qtquick-particles` `qml6-module-qtquick-templates` `qt6-qpa-plugins` `qml6-module-qtdatavisualization` |
